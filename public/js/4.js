...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        showTaxHistory: function showTaxHistory() {
            this.getTaxes();
        },
        openTaxModal: function openTaxModal() {
            this.taxHistory1 = !this.taxHistory1;
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "mini_block_value"
  }, [_c('h3', [_vm._v("Информация об уплате налогов и других обязательных платежей")]), _vm._v(" "), (!_vm.loadButton && !_vm.taxButton && _vm.$store.state.authState != 'guest') ? _c('button', {
  ...
  }, [_vm._v("Показать")]) : _vm._e(), _vm._v(" "), (_vm.loadButton && _vm.$store.state.authState != 'guest') ? _c('button', {
    staticClass: "btn btn-outline-secondary",
    attrs: {
      "type": "button",
      "disabled": ""
    }
  }, [_vm._v("Загрузка")]) : _vm._e(), _vm._v(" "), (_vm.taxButton) ? _c('button', {
    staticClass: "btn btn-outline-dark",
    attrs: {
      "type": "button"
    },
